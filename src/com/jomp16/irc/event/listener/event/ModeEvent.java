...
public class ModeEvent {
    ...
    private com.jomp16.irc.event.events.ModeEvent.Modes mode;
    private Logger logger;

    public ModeEvent(IRCManager ircManager, User user, Channel channel, String userModed, com.jomp16.irc.event.events.ModeEvent.Modes mode, Logger logger) {
    ...
    public com.jomp16.irc.event.events.ModeEvent.Modes getMode() {
        return mode;
    }
